...
export const BentoGridItem = ({
  ...
  return (
    ...
    >
      ...
      <div className="group absolute bottom-3 xs:bottom-4 right-3 xs:right-4 inline-flex items-center gap-1 text-xs xs:text-sm text-violet-400 hover:text-white transition-all duration-300">
        Learn More
        <IconArrowRight
          size={16}
