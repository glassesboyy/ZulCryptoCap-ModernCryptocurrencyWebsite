export const newsData = [
  {
    ...
    title: "Bitcoin ETF Launch Drives Market Surge",
    src: "/news/news1.jpg",
    description:
      "The launch of Bitcoin ETFs sends shockwaves through the crypto market, pushing Bitcoin prices to historic highs.",
    isTrending: true,
  },
  {
    id: 2,
    categories: ["Ethereum", "DeFi"],
    title: "Ethereum's Layer-2 Explosion Boosts DeFi",
    src: "/news/news2.jpg",
    description:
      "Layer-2 solutions on Ethereum see massive adoption, accelerating the growth of DeFi platforms.",
    isTrending: true,
  },
  {
    id: 3,
    categories: ["Altcoin"],
    title: "Emerging Altcoin Hits $1B Market Cap",
    src: "/news/news3.jpg",
    description:
      "A newly launched altcoin quickly reaches a billion-dollar market cap, attracting attention from major investors.",
    isTrending: true,
  },
  {
    id: 4,
    categories: ["Exchange", "Market Analysis"],
    title: "Crypto Exchanges Report Record Trading Volumes",
    src: "/news/news4.jpg",
    description:
      "Exchanges around the world report record-breaking trading volumes amid rising market optimism.",
    isTrending: true,
  },
  {
    id: 5,
    ...
    src: "/news/news5.jpg",
    description:
      "The EU finalizes a comprehensive framework for cryptocurrency regulation, promoting investor protection and market integrity.",
    isTrending: true,
  },
  {
    id: 6,
    categories: ["Bitcoin"],
    title: "Bitcoin Mining Shifts to Renewable Energy",
    src: "/news/news6.jpg",
    description:
      "A growing number of Bitcoin mining operations are turning to renewable energy sources to power their activities.",
    isTrending: true,
  },
  {
    id: 7,
    categories: ["Ethereum", "Altcoin"],
    title: "Ethereum Competitor Gains Ground in Smart Contracts",
    src: "/news/news7.jpg",
    description:
      "A new blockchain platform challenges Ethereum's dominance in the smart contract space.",
    isTrending: true,
  },
  {
    id: 8,
...
export const getNewsItems = (count, filterFn = null) => {
  let filteredNews = filterFn ? newsData.filter(filterFn) : newsData;
  return filteredNews.slice(0, count);
};

export const getTrendingNews = (count = 7) => {
  return getNewsItems(count, (item) => item.isTrending);
};

export const getLatestNews = (count = 7) => {
  return getNewsItems(count);
};

export const getCategories = () => {
  const allCategories = newsData.reduce((acc, news) => {
    news.categories.forEach((category) => acc.add(category));
    return acc;
  }, new Set());
...
function getCategoryColor(category) {
  const colors = {
    Bitcoin: "from-orange-400/10 to-orange-600/10",
    Ethereum: "from-blue-400/10 to-blue-600/10",
    Altcoin: "from-green-400/10 to-green-600/10",
    DeFi: "from-purple-400/10 to-purple-600/10",
    NFT: "from-pink-400/10 to-pink-600/10",
    Exchange: "from-yellow-400/10 to-yellow-600/10",
    Regulations: "from-red-400/10 to-red-600/10",
    "Market Analysis": "from-cyan-400/10 to-cyan-600/10",
  };
  return colors[category] || "from-violet-400/10 to-violet-600/10";
}
